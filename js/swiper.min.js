...
!function () {
    ...
    window.Swiper = function (e, a) {
        ...
        function n(e) {
            ...
            if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                if (37 === a || 39 === a || 38 === a || 40 === a) {
                    ...
                    }, i = window.innerWidth, n = window.innerHeight, o = f.container.offset(), l = [[o.left, o.top], [o.left + f.width, o.top], [o.left, o.top + f.height], [o.left + f.width, o.top + f.height]], p = 0; p < l.length; p++) {
                        var d = l[p];
        ...
        function o(e) {
            e.originalEvent && (e = e.originalEvent);
            var a = f._wheelEvent, s = 0;
            if (e.detail) s = -e.detail; else if ("mousewheel" === a) if (f.params.mousewheelForceToAxis) if (t()) {
        ...
        a = a || {};
        for (var c in d) if ("undefined" == typeof a[c]) a[c] = d[c]; else if ("object" == typeof a[c]) for (var m in d[c]) "undefined" == typeof a[c][m] && (a[c][m] = d[c][m]);
        var f = this;
        ...
        if (h = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7, h && (f.$ = h, f.container = h(e), 0 !== f.container.length)) {
            ...
            f.container[0].swiper = f, f.container.data("swiper", f), f.classNames.push("swiper-container-" + f.params.direction), f.params.freeMode && f.classNames.push("swiper-container-free-mode"), f.support.flexbox || (f.classNames.push("swiper-container-no-flexbox"), f.params.slidesPerColumn = 1), (f.params.parallax || f.params.watchSlidesVisibility) && (f.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(f.params.effect) >= 0 && (f.support.transforms3d ? (f.params.watchSlidesProgress = !0, f.classNames.push("swiper-container-3d")) : f.params.effect = "slide"), "slide" !== f.params.effect && f.classNames.push("swiper-container-" + f.params.effect), "cube" === f.params.effect && (f.params.resistanceRatio = 0, f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.centeredSlides = !1, f.params.spaceBetween = 0, f.params.virtualTranslate = !0, f.params.setWrapperSize = !1), "fade" === f.params.effect && (f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.watchSlidesProgress = !0, f.params.spaceBetween = 0, "undefined" == typeof u && (f.params.virtualTranslate = !0)), f.params.grabCursor && f.support.touch && (f.params.grabCursor = !1), f.wrapper = f.container.children("." + f.params.wrapperClass), f.params.pagination && (f.paginationContainer = h(f.params.pagination), f.params.paginationClickable && f.paginationContainer.addClass("swiper-pagination-clickable")), f.rtl = t() && ("rtl" === f.container[0].dir.toLowerCase() || "rtl" === f.container.css("direction")), f.rtl && f.classNames.push("swiper-container-rtl"), f.rtl && (f.wrongRTL = "-webkit-box" === f.wrapper.css("display")), f.params.slidesPerColumn > 1 && f.classNames.push("swiper-container-multirow"), f.device.android && f.classNames.push("swiper-container-android"), f.container.addClass(f.classNames.join(" ")), f.translate = 0, f.progress = 0, f.velocity = 0, f.lockSwipeToNext = function () {
                ...
                var e, a = f.params.spaceBetween, s = 0, r = 0, i = 0;
                ...
                for (e = 0; e < f.slides.length; e++) {
                    ...
                    if (f.params.slidesPerColumn > 1) {
                        ...
                        "column" === f.params.slidesPerColumnFill ? (d = Math.floor(e / m), u = e - d * m, p = d + u * n / m, l.css({
                            ...
                            "-webkit-order": p,
                            order: p
                        })) : (c = n / m, u = Math.floor(e / c), d = e - u * c), l.css({"margin-top": 0 !== u && f.params.spaceBetween && f.params.spaceBetween + "px"}).attr("data-swiper-column", d).attr("data-swiper-row", u)
                    }
                ...
                if ("undefined" == typeof e && (e = f.translate || 0), 0 !== f.slides.length) {
                    ...
                    for (var s = 0; s < f.slides.length; s++) {
                        var r = f.slides[s], i = f.params.centeredSlides === !0 ? r.swiperSlideSize / 2 : 0,
                            n = (a - r.swiperSlideOffset - i) / (r.swiperSlideSize + f.params.spaceBetween);
                        if (f.params.watchSlidesVisibility) {
                            var o = -(a - r.swiperSlideOffset - i), l = o + f.slidesSizesGrid[s],
            ...
            window.navigator.pointerEnabled ? v = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (v = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), f.touchEvents = {
                ...
                var t = e ? "off" : "on", s = e ? "removeEventListener" : "addEventListener",
                    r = "container" === f.params.touchEventsTarget ? f.container[0] : f.wrapper[0],
                    i = f.support.touch ? r : document, n = f.params.nested ? !0 : !1;
                ...
                if (f.clickedSlide = a, f.clickedIndex = h(a).index(), f.params.slideToClickedSlide && void 0 !== f.clickedIndex && f.clickedIndex !== f.activeIndex) {
                    ...
                    if (f.params.loop) if (t = h(f.clickedSlide).attr("data-swiper-slide-index"), s > f.slides.length - f.params.slidesPerView) f.fixLoop(), s = f.wrapper.children("." + f.params.slideClass + '[data-swiper-slide-index="' + t + '"]').eq(0).index(), setTimeout(function () {
                        f.slideTo(s)
            ...
            var g, w, b, y, x, T, S, C, M, P = "input, select, textarea, button", z = Date.now(), I = [];
            f.animating = !1, f.touches = {startX: 0, startY: 0, currentX: 0, currentY: 0, diff: 0};
            var E, k;
            if (f.onTouchStart = function (e) {
                ...
                if (e.originalEvent && (e = e.originalEvent), f.emit("onTouchEnd", f, e), g) {
                    ...
                    if (s = f.params.followFinger ? f.rtl ? f.translate : -f.translate : -x, f.params.freeMode) {
                        ...
                        if (f.params.freeModeMomentum) {
                            if (I.length > 1) {
                                var r = I.pop(), i = I.pop(), n = r.position - i.position, o = r.time - i.time;
                            ...
                            I.length = 0;
                            var l = 1e3 * f.params.freeModeMomentumRatio, p = f.velocity * l, d = f.translate + p;
                            f.rtl && (d = -d);
                            var u, c = !1, m = 20 * Math.abs(f.velocity) * f.params.freeModeMomentumBounceRatio;
                    ...
                    var v, y = 0, S = f.slidesSizesGrid[0];
                ...
                if (f.params.observeParents) for (var e = f.container.parents(), a = 0; a < e.length; a++) i(e[a]);
                i(f.container[0], {childList: !1}), i(f.wrapper[0], {attributes: !1})
                ...
                if (f.params.loop && f.destroyLoop(), "object" == typeof e && e.length) for (var a = 0; a < e.length; a++) e[a] && f.wrapper.append(e[a]); else f.wrapper.append(e);
                ...
                fade: {
                    fadeIndex: null, setTranslate: function () {
                        for (var e = 0; e < f.slides.length; e++) {
                            var a = f.slides.eq(e), s = a[0].swiperSlideOffset, r = -s;
                            ...
                            n > 0 && 1 > n && (f.effects.fade.fadeIndex = e), a.css({opacity: n}).transform("translate3d(" + r + "px, " + i + "px, 0px)")
                        }
                    ...
                    setTranslate: function () {
                        var e, a = 0;
                        f.params.cube.shadow && (t() ? (e = f.wrapper.find(".swiper-cube-shadow"), 0 === e.length && (e = h('<div class="swiper-cube-shadow"></div>'), f.wrapper.append(e)), e.css({height: f.width + "px"})) : (e = f.container.find(".swiper-cube-shadow"), 0 === e.length && (e = h('<div class="swiper-cube-shadow"></div>'), f.container.append(e))));
                        for (var s = 0; s < f.slides.length; s++) {
                            var r = f.slides.eq(s), i = 90 * s, n = Math.floor(i / 360);
                        ...
                        }), f.params.cube.shadow) if (t()) e.transform("translate3d(0px, " + (f.width / 2 + f.params.cube.shadowOffset) + "px, " + -f.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + f.params.cube.shadowScale + ")"); else {
                            var v = Math.abs(a) - 90 * Math.floor(Math.abs(a) / 90),
                                g = 1.5 - (Math.sin(2 * v * Math.PI / 360) / 2 + Math.cos(2 * v * Math.PI / 360) / 2),
                                w = f.params.cube.shadowScale, b = f.params.cube.shadowScale / g,
                    ...
                    setTranslate: function () {
                        for (var e = f.translate, a = t() ? -e + f.width / 2 : -e + f.height / 2, s = t() ? f.params.coverflow.rotate : -f.params.coverflow.rotate, r = f.params.coverflow.depth, i = 0, n = f.slides.length; n > i; i++) {
                            var o = f.slides.eq(i), l = f.slidesSizesGrid[i], p = o[0].swiperSlideOffset,
                                d = (a - p - l / 2) / l * f.params.coverflow.modifier, u = t() ? s * d : 0,
                                c = t() ? 0 : s * d, m = -r * Math.abs(d), v = t() ? 0 : f.params.coverflow.stretch * d,
                ...
                initialImageLoaded: !1, loadImageInSlide: function (e) {
                    ...
                    }); else if (f.params.slidesPerView > 1) for (var e = f.activeIndex; e < f.activeIndex + f.params.slidesPerView; e++) f.slides[e] && f.lazy.loadImageInSlide(e); else f.lazy.loadImageInSlide(f.activeIndex);
                ...
                set: function () {
                    ...
                    if (f.params.scrollbar) {
                        var e, a = f.scrollbar, s = (f.translate || 0, a.dragSize);
                ...
                init: function () {
                    if (f.params.hashnav) {
                        ...
                        if (e) for (var a = 0, t = 0, s = f.slides.length; s > t; t++) {
                            var r = f.slides.eq(t), i = r.attr("data-hash");
            ...
            f.disableMousewheelControl = function () {
                ...
                setTranslate: function () {
                    ...
                    "undefined" == typeof e && (e = f.params.speed), f.container.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function () {
                        var a = h(this), t = parseInt(a.attr("data-swiper-parallax-duration"), 10) || e;
            ...
            return f.callPlugins = function (e) {
                ...
                var a;
                if (f.emitterEventListeners[e]) for (a = 0; a < f.emitterEventListeners[e].length; a++) f.emitterEventListeners[e][a](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
